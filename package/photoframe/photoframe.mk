...
define PHOTOFRAME_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 $(PHOTOFRAME_PKGDIR)/no_S78firstboot $(TARGET_DIR)/data/etc/no_S78firstboot
	$(INSTALL) -D -m 0644 $(PHOTOFRAME_PKGDIR)/no_S79usb_share $(TARGET_DIR)/data/etc/no_S79usb_share
endef
